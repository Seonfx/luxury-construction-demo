...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="flex justify-between items-center px-6 lg:px-16 py-8 lg:py-6 z-50 relative shrink-0">
        <div className="flex items-center gap-2 lg:gap-3 font-semibold tracking-widest text-[0.9rem] lg:text-[1.1rem]">
          <svg 
